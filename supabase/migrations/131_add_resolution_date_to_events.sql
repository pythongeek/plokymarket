...
-- Backfill resolution_date from trading_closes_at where null
UPDATE public.events 
SET resolution_date = trading_closes_at 
WHERE resolution_date IS NULL AND trading_closes_at IS NOT NULL;
