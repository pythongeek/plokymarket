-- Multi-Source Verification Architecture Schema
...
-- 6. Cross-Verification Audit Trail
CREATE TABLE IF NOT EXISTS public.cross_verification_audit (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_source_outcomes_recorded ON public.source_outcome_records(recorded_at);
