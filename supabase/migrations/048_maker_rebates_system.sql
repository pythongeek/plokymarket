...
DROP TABLE IF EXISTS spread_rewards CASCADE;
DROP TABLE IF EXISTS maker_rebates CASCADE;
DROP TABLE IF EXISTS maker_volume_tracking CASCADE;
DROP TABLE IF EXISTS resting_orders CASCADE;
...
CREATE TABLE resting_orders (
    ...
    spread_at_placement DECIMAL(8, 4), -- Spread % when order was placed
...
-- ===================================
CREATE TABLE maker_volume_tracking (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    year_month VARCHAR(7) NOT NULL, -- Format: YYYY-MM
    maker_volume DECIMAL(20, 2) DEFAULT 0, -- Volume as maker
    taker_volume DECIMAL(20, 2) DEFAULT 0, -- Volume as taker
    total_spread_contribution DECIMAL(20, 4) DEFAULT 0, -- Time-weighted spread contribution
    resting_time_seconds INTEGER DEFAULT 0, -- Total resting time
    qualifying_volume DECIMAL(20, 2) DEFAULT 0, -- Volume meeting minimum resting time
    rebate_tier INTEGER DEFAULT 1, -- 1-4 tier
    rebate_rate DECIMAL(8, 4) DEFAULT 0.0002, -- Current rebate rate (0.02% = 0.0002)
    estimated_rebate DECIMAL(20, 2) DEFAULT 0, -- Estimated rebate for month
    claimed_rebate DECIMAL(20, 2) DEFAULT 0, -- Already claimed
...
CREATE TABLE maker_rebates (
    ...
    qualifying_volume DECIMAL(20, 2) DEFAULT 0, -- Volume with >1s resting time
    ...
    -- Tier info at time of calculation
...
CREATE TABLE spread_rewards (
    ...
    -- Spread metrics
    avg_spread_7d DECIMAL(8, 4), -- 7-day time-weighted average spread
    min_spread DECIMAL(8, 4),
    max_spread DECIMAL(8, 4),
    spread_percentile DECIMAL(5, 2), -- How user ranks vs others
...
-- ===================================
CREATE TABLE rebate_tiers_config (
...
-- ===================================
CREATE TABLE spread_multiplier_config (
    id INTEGER PRIMARY KEY,
...
BEGIN
    ...
    -- Insert or update volume tracking
    ...
    -- Get updated volume and determine new tier
    ...
    -- Update tier and estimated rebate
...
BEGIN
    ...
    -- Get volume tracking for the period
    ...
    -- Get spread reward for the period
...
-- View for current rebate status
...
ALTER TABLE resting_orders ENABLE ROW LEVEL SECURITY;
ALTER TABLE maker_volume_tracking ENABLE ROW LEVEL SECURITY;
ALTER TABLE maker_rebates ENABLE ROW LEVEL SECURITY;
ALTER TABLE spread_rewards ENABLE ROW LEVEL SECURITY;
