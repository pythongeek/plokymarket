...
-- ===============================================
-- STEP 2: Insert workflow configurations for cron-job.org
-- ===============================================
...
-- ===============================================
-- STEP 4: Update cron frequencies in workflow_schedule_configs (if table exists)
-- ===============================================
...
-- ===============================================
-- This migration:
-- 1. Creates workflow_configs table for simplified workflow management
-- 2. Inserts 16 workflow configurations with cron-job.org schedules
-- 3. Ensures admin_ai_settings table exists (fixes AI Topics failure)
-- 4. Adds diagnostic functions for monitoring
-- ===============================================
