...
export function MarketPageClient({ initialMarket }: MarketPageClientProps) {
        ...
        <div className="space-y-6">
            ...
            {(() => {
                ...
                if (isPlatformPaused || isCategoryPaused || isMarketPaused) {
                    ...
                    const pausedAt = isPlatformPaused ? undefined : isCategoryPaused ? undefined : market?.paused_at;
            ...
            <MarketStatusDisplay
                market={market}
                oracleConfidence={market.resolution_details?.ai_confidence || 85}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <CardContent className="p-0">
                            {market.outcomes && market.outcomes.length > 0 ? (
                                <div className="p-6 border-b border-primary/5">
                                    <h3 className="text-sm font-semibold mb-4 text-muted-foreground uppercase tracking-wider">Outcomes</h3>
                                    <MultiOutcomeList
                    ...
                    {/* Tabs for Activity, Comments, and Rankings */}
                    <div className="mt-10 pt-10 border-t border-primary/10">
                        <Tabs defaultValue="activity" className="w-full">
                            <TabsList className="bg-slate-800 border border-slate-700 w-full justify-start h-12 p-1 gap-2">
                                <TabsTrigger
                                    value="activity"
                            ...
                            <TabsContent value="activity" className="mt-6">
                                <ActivityFeed
                                    marketId={market.id}
                                    filterTypes={['trader_activity', 'market_movement']}
                                />
                            </TabsContent>
            ...
            {!isResolved && (
                <MobileTradingBar
                    ...
                    disabled={isPlatformPaused || (market ? (categoryPauseStatus.get(market.category)?.paused || market.trading_status === 'paused') : false)}
                />
            )}
        </div>
    );
