    ...
    <div className="space-y-6">
        ...
        {[...Array(3)].map((_, i) => (
          <Card key={i} className="h-40">
            <div className="p-4 space-y-3">
              ...
              <div className="h-8 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded w-1/2 animate-shimmer bg-[length:200%_100%]" />
              <div className="h-3 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded w-full animate-shimmer bg-[length:200%_100%]" />
            </div>
          </Card>
        ))}
      </div>
      <Card className="h-96">
        <div className="p-6 space-y-4">
          <div className="h-6 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded w-1/4 animate-shimmer bg-[length:200%_100%]" />
          ...
          <div className="h-64 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded animate-shimmer bg-[length:200%_100%]" />
        </div>
      </Card>
    </div>
  );
