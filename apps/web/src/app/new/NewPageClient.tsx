...
import {
  Search, Sparkles, TrendingUp, Clock, BarChart3, ChevronRight,
  Newspaper, ArrowUpRight, ArrowDownRight, Activity, LayoutGrid,
  Filter, List, Flame, Calendar, Zap, SortAsc,
} from 'lucide-react';
...
function SectionHeader({ icon: Icon, title, count, action }: {
  ...
  return (
    <div className="flex items-center justify-between mb-4">
      ...
      {action && (
        <Link href={action.href} className="text-xs font-bold text-blue-600 hover:text-blue-700 flex items-center gap-0.5">
      ...
      <div className="flex flex-col md:flex-row">
        <div className="relative w-full md:w-[380px] h-[200px] md:h-[240px] shrink-0 bg-gray-100 overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex gap-2">
            <span className="bg-blue-600 text-white text-[11px] font-extrabold px-2.5 py-1 rounded-full flex items-center gap-1 shadow-lg">
        ...
        <div className="flex-1 p-5 flex flex-col justify-between">
          <div>
            ...
            <p className="text-[13px] text-gray-500 leading-relaxed line-clamp-2 mb-3">
              {item.description || `${item.category} বিষয়ক একটি নতুন প্রেডিকশন মার্কেট। বাজারের প্রবণতা অনুযায়ী আপনার পজিশন নিন।`}
            </p>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative w-28 h-20 sm:w-36 sm:h-24 shrink-0 rounded-lg overflow-hidden bg-gray-100">
        ...
        {index < 3 && (
          <div className="absolute top-1.5 left-1.5 bg-blue-500 text-white text-[9px] font-extrabold px-1.5 py-0.5 rounded">
            নতুন
          </div>
        )}
      </div>
...
// ── Main ───────────────────────────────────────────────
export default function NewPageClient({ items, stats }: Props) {
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="bg-blue-600 text-white text-xs font-extrabold px-3 py-1 rounded-full flex items-center gap-1">
                  <Sparkles className="w-3.5 h-3.5" /> নতুন মার্কেট
                </span>
                <span className="text-xs text-gray-400">সম্প্রতি যোগ হয়েছে</span>
              </div>
              <h1 className="text-2xl md:text-3xl font-black text-gray-900">সর্বশেষ মার্কেট</h1>
              <p className="text-sm text-gray-500 mt-1">নতুন প্রেডিকশন মার্কেট খুঁজুন এবং প্রথম ট্রেড করুন</p>
            </div>
            <div className="flex items-center gap-4">
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1 px-3 py-1.5 rounded-full text-[12px] font-semibold whitespace-nowrap border transition-all ${
                        isActive ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-600 border-gray-200 hover:border-gray-300'
                      }`}
                    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0">
            {featured && (
              <div className="mb-6">
                <SectionHeader icon={Sparkles} title="শীর্ষ নতুন মার্কেট" action={{ label: 'সব দেখুন', href: '/markets' }} />
                <FeaturedCard item={featured} />
              </div>
            )}
            {rest.length > 0 && (
              <div className="mb-6">
                <SectionHeader icon={List} title="সর্বশেষ মার্কেট" count={toBengali(rest.length)} />
          ...
          <aside className="w-80 shrink-0 hidden lg:block space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-4 shadow-sm">
              <div className="flex items-center gap-2 mb-3">
                <div className="bg-blue-50 rounded-lg p-1.5"><TrendingUp className="w-4 h-4 text-blue-600" /></div>
              ...
              <Link href="/markets" className="flex items-center justify-center gap-1 text-xs font-bold text-blue-600 mt-3 py-2 hover:bg-blue-50 rounded-lg transition-colors">
            ...
            <div className="bg-blue-50 rounded-2xl border border-blue-100 p-4">
              <div className="font-extrabold text-sm text-blue-900 mb-1">নতুন মার্কেট অ্যালার্ট</div>
              <p className="text-xs text-blue-600 mb-3">নতুন মার্কেট যোগ হলে সঙ্গে সঙ্গে নোটিফিকেশন পেতে সাবস্ক্রাইব করুন</p>
              <div className="flex gap-2">
                <input placeholder="ইমেইল" className="flex-1 text-xs px-3 py-2 rounded-lg border border-blue-200 outline-none focus:border-blue-500" />
                <button className="bg-blue-600 text-white text-xs font-bold px-3 py-2 rounded-lg hover:bg-blue-700 transition-colors">সাবস্ক্রাইব</button>
              </div>
            </div>
          </aside>
        </div>
