...
export type TradingStatus = 'active' | 'paused' | 'resolved' | 'cancelled';
...
// ===================================
// EVENTS/MARKETS (Reimplemented from 094_reimplemented_events_markets.sql)
// ===================================

export type EventStatus = 'draft' | 'pending' | 'active' | 'paused' | 'closed' | 'resolved' | 'cancelled';
...
export interface Event {
  ...
  // Core Identity
  name: string;           // Display title (spec §1.1.1)
  title: string;          // Kept for backward compat, synced with name
  question: string;
  description?: string;
  ticker?: string;
...
// Event creation payload (subset of Event)
...
// Event with market count (for admin listings)
