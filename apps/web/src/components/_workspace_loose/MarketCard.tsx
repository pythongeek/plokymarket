...
import { Clock, BarChart3, BadgeCheck, Bookmark, Share2 } from 'lucide-react';
    ...
    <Link href={`/markets/${market.id}`} className="block h-full cursor-pointer focus:outline-none">
      ...
      >
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          {/* Bengali Outcome Buttons */}
          <div className="flex gap-2 mb-3">
            <button className="flex-1 py-1.5 bg-green-50 text-green-600 text-xs font-bold rounded-lg hover:bg-green-100 transition">
              হ্যাঁ
            </button>
            <button className="flex-1 py-1.5 bg-red-50 text-red-600 text-xs font-bold rounded-lg hover:bg-red-100 transition">
              না
            </button>
          </div>
